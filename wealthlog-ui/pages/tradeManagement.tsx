...
export default function TradeManagement() {
  ...
  const handleAddTrade = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.post("/trades", body, { withCredentials: true });
  ...
  const handleDeleteTrade = async (tradeId: number) => {
    ...
    try {
      await api.delete(`/trades/${tradeId}`, { withCredentials: true });
      await loadTradesForAccount(selectedAccountId);
    } catch (err) {
        ...
        >
          ...
          <form onSubmit={handleCreateAccount}>
            ...
            <button
              ...
              style={{ backgroundColor: "#00C853" }} // Bright Emerald
            >
              Create FX Account
            </button>
          </form>
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#FAFAFA", color: "#37474F" }} // Soft White BG, dark text
    >
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            ...
            style={{ backgroundColor: "#00796B" }} // Deep Teal
          >
        ...
        <form
          ...
          className="mt-4 p-6 rounded shadow"
        ...
        <div className="mt-6 flex items-center gap-4">
          ...
          <button
            ...
            style={{ backgroundColor: "#FFD700" }} // Royal Gold
          ...
          <table className="w-full mt-4 border-collapse">
            <thead>
              <tr style={{ backgroundColor: "#FAFAFA", borderColor: "#37474F" }}>
                <th className="border p-2" style={{ borderColor: "#37474F" }}>
                  Date/Time
                </th>
                <th className="border p-2" style={{ borderColor: "#37474F" }}>
                  Instrument
...
function EditTradeModal({
  ...
  return (
    ...
    >
      <div
        className="p-6 rounded shadow-md w-full max-w-md relative"
      ...
      >
        ...
        <div className="mt-2">
          ...
          <select
            ...
            onChange={(e) =>
              setTrade((t) =>
                t && { ...t, tradeDirection: e.target.value as "LONG" | "SHORT" }
              )
            }
          >
            <option value="LONG">Long</option>
